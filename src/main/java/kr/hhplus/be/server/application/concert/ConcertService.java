...
public class ConcertService {
    ...
    public SeatListResponse getSeats(String date) {
        ...
        List<kr.hhplus.be.server.interfaces.api.concert.dto.SeatStatus> seatStatusList = seats.stream()
     ...
     * Seat 엔티티를 DTO로 변환
     */
    private kr.hhplus.be.server.interfaces.api.concert.dto.SeatStatus toSeatStatusDto(Seat seat) {
        return new kr.hhplus.be.server.interfaces.api.concert.dto.SeatStatus(
                seat.getSeatNumber(),
    ...
    private kr.hhplus.be.server.interfaces.api.concert.dto.SeatStatus.SeatStatusEnum mapStatus(SeatStatus status) {
        return switch (status) {
            case AVAILABLE -> kr.hhplus.be.server.interfaces.api.concert.dto.SeatStatus.SeatStatusEnum.AVAILABLE;
            case TEMP_HELD -> kr.hhplus.be.server.interfaces.api.concert.dto.SeatStatus.SeatStatusEnum.TEMP_HELD;
            case RESERVED -> kr.hhplus.be.server.interfaces.api.concert.dto.SeatStatus.SeatStatusEnum.RESERVED;
        };
    }
}
